...
const PAGE_SECTION_MAP = {
  ...
  'tiktok.html': 'tiktok',
  'videoedit.html': 'videoedit',
  'text-post.html': 'text-post',
  'pages.html': 'pages',
...
function renderNav(active) {
  const items = [
    ...
    { href: 'videoedit.html', label: 'Video Editor', icon: '✂', key: 'videoedit' },
    { href: 'text-post.html', label: 'Text + Image Post', icon: '✎', key: 'text-post' },
